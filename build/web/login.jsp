    ...
    <body>
        ...
        <div id="login-container">
            ...
            <h1 class="h2 text-light text-center push-top-bottom animation-slideDown">
                <strong>ยินดีต้อนรับสู่ เบาหวาน</strong>.com
            </h1>
            <!-- END Login Header -->
                ...
                <form id="form-login" action="Login" method="post" class="form-horizontal">
                    <div class="form-group">
                        <div class="col-xs-12">
                            ...
                            <input type="text" id="username" name="username" class="form-control" placeholder="อีเมล์/ชื่อผู้ใช้">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-xs-12">
                    ...
                    <div class="form-group form-actions">
                        ...
                        <div class="col-xs-4 text-right">
                            <button type="submit" class="btn btn-effect-ripple btn-sm btn-primary"><i class="fa fa-check"></i> เข้าสู่ระบบ</button>
                        </div>
                    </div>
                </form>
                <!-- END Login Form -->
