...
public final class calendar_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("                                </li>\n");
      out.write("                                <li>\n");
      out.write("                                    <a href=\"calendar\" class=\"active\"><i class=\"fa fa-calendar sidebar-nav-icon\"></i><span class=\"sidebar-nav-mini-hide\">ปฏิทิน</span></a>\n");
      out.write("                                </li>\n");
      out.write("                                <li>\n");
      ...
      out.write("                    ");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${req}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write("\n");
      out.write("                        <!-- FullCalendar Block -->\n");
      out.write("                        <div class=\"block full\">\n");
      out.write("                            <div class=\"row\">\n");
      out.write("                                <a href=\"#modal-small\" class=\"btn btn-effect-ripple btn-primary\" data-toggle=\"modal\">เพิ่มการนัดหมาย</a>\n");
      out.write("\n");
      out.write("                                    <!-- FullCalendar (initialized in js/pages/compCalendar.js), for more info and examples you can check out http://arshaw.com/fullcalendar/ -->\n");
      out.write("                                    <div id=\"calendar\"></div>\n");
      out.write("                            </div>\n");
      out.write("                        </div>\n");
      out.write("                        <!-- END FullCalendar Block -->\n");
      out.write("\n");
      out.write("                    </div>\n");
      ...
      out.write("        <script>\n");
      out.write("var CompCalendar = function() {\n");
      out.write("    var calendarEvents  = $('.calendar-events');\n");
      out.write("\n");
      out.write("    /* Function for initializing drag and drop event functionality */\n");
      out.write("    var initEvents = function() {\n");
      out.write("        calendarEvents.find('li').each(function() {\n");
      out.write("            // create an Event Object (http://arshaw.com/fullcalendar/docs/event_data/Event_Object/)\n");
      out.write("            var eventObject = { title: $.trim($(this).text()), color: $(this).css('background-color') };\n");
      out.write("\n");
      ...
      out.write("            $(this).draggable({ zIndex: 999, revert: true, revertDuration: 0 });\n");
      out.write("        });\n");
      out.write("    };\n");
      out.write("\n");
      out.write("    return {\n");
      out.write("        init: function() {\n");
      out.write("            /* Initialize drag and drop event functionality */\n");
      out.write("            initEvents();\n");
      out.write("\n");
      out.write("            /* Add new event in the events list */\n");
      out.write("            var eventInput      = $('#add-event');\n");
      out.write("            var eventInputVal   = '';\n");
      out.write("\n");
      out.write("            // When the add button is clicked\n");
      out.write("            $('#add-event-btn').on('click', function(){\n");
      out.write("                // Get input value\n");
      out.write("                eventInputVal = eventInput.prop('value');\n");
      out.write("\n");
      out.write("                // Check if the user entered something\n");
      out.write("                if ( eventInputVal ) {\n");
      out.write("                    // Add it to the events list\n");
      out.write("                    calendarEvents.prepend('<li class=\"animation-fadeInQuick2Inv\"><i class=\"fa fa-calendar\"></i> ' + $('<div />').text(eventInputVal).html() + '</li>');\n");
      out.write("\n");
      out.write("                    // Clear input field\n");
      out.write("                    eventInput.prop('value', '');\n");
      out.write("\n");
      out.write("                    // Init Events\n");
      out.write("                    initEvents();\n");
      out.write("\n");
      out.write("                    // Focus the input at the end\n");
      out.write("                    eventInput.focus();\n");
      out.write("                }\n");
      out.write("\n");
      out.write("                // Don't let the form submit\n");
      ...
      out.write("                    center: '',\n");
      out.write("                    right: 'today month,agendaWeek,agendaDay prev,next'\n");
      out.write("                },\n");
      out.write("                firstDay: 1,\n");
      out.write("                editable: false,\n");
      out.write("                droppable: false,\n");
      out.write("                events: ");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${cal}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write("\n");
      out.write("            });\n");
      out.write("        }\n");
      out.write("    };\n");
      out.write("}();\n");
      out.write("</script>\n");
      out.write("<script>$(function(){ CompCalendar.init(); });</script>\n");
      out.write("<script src=\"js/pages/uiTypography.js\"></script>\n");
      out.write("        <script>$(function(){ UiTypography.init(); });</script>\n");
      out.write("\n");
      out.write("    </body>\n");
      out.write("</html>");
    } catch (Throwable t) {
