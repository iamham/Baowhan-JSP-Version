                    ...
                    <header class="navbar navbar-inverse navbar-fixed-top">
                        ...
                        <ul class="nav navbar-nav-custom">
                            ...
                            <li class="hidden-xs animation-fadeInQuick">
                                <a href=""><strong>แก้ไขบันทึก</strong></a>
                            </li>
                            <!-- END Main Sidebar Toggle Button -->
                            ...
                            <!-- General Elements Block -->
                                <div class="block">
                                    ...
                                    <div class="block-title">
                                        ...
                                        <h2>แก้ไขข้อมูลใหม่</h2>
                                    </div>
                                    <!-- END General Elements Title -->

                                    <!-- General Elements Content -->
                                    <form action="editMe" method="post"  class="form-horizontal form-bordered" >
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" for="id">ID</label>
                                            <div class="col-md-6">
                                                <input type="text" id="id" name="id" class="form-control" value="${id}" hidden required>
                                        ...
                                        <div class="col-md-5">
                                            <input type="text" id="date" name="date" class="form-control input-datepicker" data-date-format="dd/mm/yy" value="${date}" required>
                                        </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <input type="number" id="bvalue" name="bvalue" class="form-control" value="${value}" required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <textarea id="note" name="note" rows="7" class="form-control">${note}</textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group form-actions">
                                            <div class="col-md-9 col-md-offset-3">
                                                ...
                                                <button type="checkRecord" class="btn btn-effect-ripple btn-danger">ยกเลิก</button>
                                            </div>
                                        </div>
                                    </form>
                            ...
                            <!-- General Elements Block -->
                                <div class="block">
                                   ...
                                   <form action="#" method="post" enctype="multipart/form-data" class="form-horizontal form-bordered" onsubmit="return false;">
                                        <div class="form-group">
                                            <label class="col-md-3 control-label">วัน-เวลา</label>
                                            <div class="col-md-9">
                                                <p class="form-control-static">${date} ${time}</p>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-3 control-label">ค่าน้ำตาล</label>
                                            <div class="col-md-9">
                                                <p class="form-control-static">${value}</p>
                                            </div>
                                        </div>
                                            <div class="form-group">
                                            <label class="col-md-3 control-label">บันทึกเพิ่มเติม</label>
                                            <div class="col-md-9">
