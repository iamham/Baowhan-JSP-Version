                                ...
                                <table id="example-datatable" class="table table-striped table-bordered table-vcenter">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>ชื่อ</th>
                                            <th>โรงพยาบาล</th>
                                            <th style="width: 120px;">eAG</th>
                                            <th style="width: 120px;">อันดับที่ในการแข่งขัน</th>
                                        ...
                                        <a href="" class="widget">
                                            <div class="widget-image widget-image-sm">
                                                ...
                                                <div class="widget-image-content">
                                                    <center>
                                                    <h4 class="widget-heading text-light"><strong>คำขอจากผู้ป่วย</strong></h4>
                                                    <h4 class="widget-heading text-light"><i>คุณสามารถเลือกได้จะรับผู้ป่วย หรือไม่รับ โดยกดปุ่ม สีเขียว ด้านข้างเพื่อรับผู้ป่วยมาอยู่ในการดูแล หรือ สีแดงเมื่อไม่ต้องการรับผู้ป่วย</i></h4>
                                                    </center>
                                                </div>
