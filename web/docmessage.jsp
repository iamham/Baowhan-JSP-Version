                    ...
                    <div id="sidebar-scroll">
                        ...
                        <div class="sidebar-content">
                            ...
                            <ul class="sidebar-nav">
                                ...
                                <li>
                                    <a href="docmessage"  class="active"><i class="fa fa-comments sidebar-nav-icon"></i><span class="sidebar-nav-mini-hide">ติดต่อคนไข้</span></a>
                                </li>
                                <li>
                        ...
                        <div class="row">
                            ...
                            <!-- END Message List -->
                                    ...
                                    <div class="widget-content widget-content-mini themed-background-info text-light-op">
                                        ...
                                        <i class="fa fa-fw fa-users"></i> คนไข้ทั้งหมด
                                    </div>
                                    <div class="widget-content widget-content-full">
